...
<html lang="en">
<head>
<title>World Pediatric Society</title>
<meta charset="utf-8">
...
<div class="body1">
  <div class="main">
    ...
    <header>
      <div class="wrapper">
        <h1><a href="http://worldpediatricsociety/jcs/index.html" id="logo">World Pediatric Society</a></h1>
        <nav>
          <ul id="menu">
            <li><a href="http://worldpediatricsociety.org/jcs/index.html">Home</a></li>
            <li><a href="about.html">About </a></li>
            <li><a href="associations.html">Associations</a></li>
            <li><a href="editors.html">Editors</a></li>
            <li><a href="editorial.html">Editorial Board</a></li>
            <li><a href="http://www.thieme.com/media/ita/JCS_Author_instructions.pdf"target="_blank">Instructions</a></li>
            <li id="menu_active"><a href="archives.html">Archives</a></li>
            <li><a href="subscription.html">Subscription</a></li>
            <li><a href="http://www.thieme.com/books-main/surgery/product/4002-journal-of-child-science">THIEME PUBLISHERS</a></li>
    ...
    <article id="content">
      <div class="wrapper">
        <div class="box1">
         ...
         <h2>WORLD PEDİATRİC SOCİETY</h2>
         <h2><span>Official Journal of the World Pediatric Society, Turkiye</span></h2> 
         <br>
		 
		 <h2><font color="#12d6ce">Formerly known as Journal of Pediatric Biochemistry (2010 - 2016)</font></h2><br>
        
          <h2><a href="https://www.thieme-connect.com/products/ejournals/journal/10.1055/s-00033103">LAST ISSUE</a></h2>
...
jcs2="""
    ...
    <!-- footer -->
	<footer>
      <div class="wrapper"> <a href="http://worldpediatricsociety.org/jcs/index.html" id="footer_logo"><span>J CHILD SCIENCE</span></a>
      <div class="tel"><span>jcs</span>@erbakan.edu.tr</div>
      </div>
      <div class="wrapper"> ISSN: 1879-5390 print, ISSN: 1879-5404 online
      <ul id="icons">
...
with open("jcs.html", "w", encoding="utf-8") as file:
    print(jcs1, file=file, flush=True)
    ...
    print(jcs2, file=file, flush=True)
